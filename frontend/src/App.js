        ...
        <section id="result" className="result">
          ...
          {result && !result.error && (
            <>
              ...
              <ul>
                <li>🚦 North: <span id="north-time">{result.L1?.green}</span> seconds</li>
<li>🚦 South: <span id="south-time">{result.L2?.green}</span> seconds</li>
<li>🚦 West: <span id="west-time">{result.L3?.green}</span> seconds</li>
<li>🚦 East: <span id="east-time">{result.L4?.green}</span> seconds</li>
